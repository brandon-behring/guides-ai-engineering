...
- **#4 Working with AI — IN PROGRESS (2026-06-14).** Engineering *with* an AI assistant the way
  interviews now judge it (governing/verifying/explaining code you didn't type). Ch 0–6 authored
  ...
  draft; Movement A + B (the loop) done, remaining: C (communication, anti-patterns), D (agentic,
  evaluating-ai-output, provenance), E (capstone). Outline + work-order: `docs/guide-04-working-with-ai.md`. Plan of record:
